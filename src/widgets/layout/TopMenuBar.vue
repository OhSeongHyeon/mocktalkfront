...
<template>
  <header class="sticky top-0 z-40 border-b border-slate-200 bg-slate-50/95 backdrop-blur dark:border-slate-800 dark:bg-slate-950/92">
    <div class="flex w-full flex-col gap-2 px-3 py-2.5 sm:px-4">
      ...
      <form
        class="mx-auto flex w-full max-w-[960px] items-center gap-2 rounded-[0.6rem] border border-slate-200 bg-white px-2 py-1.5 dark:border-slate-800 dark:bg-slate-900"
